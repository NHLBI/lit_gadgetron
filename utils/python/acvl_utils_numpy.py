#Adapt script of acvl package for only numpy (remove Pytorch dependency)
#https://github.com/MIC-DKFZ/acvl_utils
#from acvl_utils.cropping_and_padding.padding import pad_nd_image
from typing import Union, List, Tuple
import numpy as np


def pad_nd_image(image: np.ndarray, new_shape: Tuple[int, ...] = None,
