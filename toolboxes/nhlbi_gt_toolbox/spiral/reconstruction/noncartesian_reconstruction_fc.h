...
namespace nhlbi_toolbox
{
    namespace reconstruction
    {
        ...
        public:
            ...
            void reconstruct_todevice(cuNDArray<float_complext> &data, cuNDArray<float_complext> &images, cuNDArray<floatd3> &trajectory_in, cuNDArray<float> &dcf_in, cuNDArray<float_complext> &csm, cuNDArray<float_complext> &cweights_ho, cuNDArray<float> &scaled_time_in, arma::fvec fbins, int deviceNo, bool forward);
            ...
            void reconstruct(cuNDArray<float_complext> &data, cuNDArray<float_complext> &images, cuNDArray<floatd3> &trajectory_in, cuNDArray<float> &dcf_in, cuNDArray<float_complext> &csm, cuNDArray<float_complext> &cweights_ho, cuNDArray<float> &scaled_time_in, arma::fvec fbins);
            ...
            void deconstruct(cuNDArray<float_complext> &images, cuNDArray<float_complext> &data, cuNDArray<floatd3> &trajectory_in, cuNDArray<float> &dcf_in, cuNDArray<float_complext> &csm, cuNDArray<float_complext> &cweights, cuNDArray<float> &scaled_time_in, arma::fvec fbins);
