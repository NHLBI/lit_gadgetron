...
// template Gadgetron::cuNDArray<float_complext> Gadgetron::cuda_utils::cuexp<float_complext>(Gadgetron::cuNDArray<float_complext> &);
// template Gadgetron::cuNDArray<float> Gadgetron::cuda_utils::cucos<float>(Gadgetron::cuNDArray<float> &);
// template Gadgetron::cuNDArray<float> Gadgetron::cuda_utils::cusin<float>(Gadgetron::cuNDArray<float> &);
