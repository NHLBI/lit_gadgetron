/*
 * mri_concomitant_field_correction_lit.h
 *
...
namespace nhlbi_toolbox
{
    ...
    {
        class mri_concomitant_field_correction_lit
        {
        public:
            mri_concomitant_field_correction_lit() = default;
            mri_concomitant_field_correction_lit(const ISMRMRD::IsmrmrdHeader &h);
