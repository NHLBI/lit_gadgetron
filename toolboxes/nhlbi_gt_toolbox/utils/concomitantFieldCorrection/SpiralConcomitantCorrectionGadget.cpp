...
public:
        ...
        float demodulation_freq)
    {
        ...
        auto phase_term = Gadgetron::cuda_utils::cuexp<float_complext>(arg_exp);
                 ...
                 OutputChannel &out) override
    {
        ...
        Gadgetron::corrections::mri_concomitant_field_correction_lit field_correction(this->header);
